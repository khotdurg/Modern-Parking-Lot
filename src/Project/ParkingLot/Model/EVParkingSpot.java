...
public class EVParkingSpot extends ParkingSpot {
    ...
    public EVParkingSpot(ParkingFloorStatus floorStatus, ParkingFloor parkingFloorNumber, Gate gateNumber, int amount, Bill bill, Payment payment, PaymentMode paymentMode, PaymentStatus paymentStatus, VehicleType vehicleType) {
